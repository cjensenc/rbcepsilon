...
rho=.9 %.9
beta=.99;%.989-.995
theta=1/.5; % 1/2, Frisch elast = 1/theta 
mu=0; %safe income
...
T=1e8 % 1e8 (if HP filtering) or 2e8, simulation length.
...
tv = datetime('now', 'Format','yyyy_MM_dd_HH_mm');
filename = sprintf('GRiskADSRCNfoc_%s.mat',tv);
